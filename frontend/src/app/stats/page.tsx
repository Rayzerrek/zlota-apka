      ...
      <div className="grid grid-cols-1 gap-6 pb-10 border-b border-[var(--rule)] mb-10 min-[800px]:grid-cols-[1.2fr_1fr] min-[800px]:gap-14 min-[800px]:items-end enter enter-d1">
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-[var(--ink-muted)] leading-relaxed">
            <strong className="text-[var(--ink)]">{STUDY_STATS.retentionPct}%</strong> kart oceniasz
            na poziomie 3 lub wyżej przy pierwszym podejściu, licząc z ostatnich 90 dni. Powyżej 85%
            — masz stabilną podstawę. Cel standardowy dla FSRS: <span className="mono">0.90</span>.
          </p>
