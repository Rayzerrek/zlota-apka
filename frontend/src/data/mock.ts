import type { Card, Exam, ReviewHistoryEntry, StudySession } from "../types/types";
...
export const CARDS: Card[] = [
	...
	},
	{
		...
		answer: "Czynność rozpoczęta w przeszłości, trwająca do teraz, często z akcentem na czas trwania",
		stage: "review",
		dueISO: "2026-04-18",
		intervalDays: 24,
		ease: 2.6,
...
export const STUDY_STATS = {
	...
	young: CARDS.filter((c) => c.stage === "learning" || (c.stage === "review" && c.intervalDays < 14))
		.length,
...
export const SUBJECT_RETENTION: { subject: import("../types/types").SubjectKey; pct: number }[] = [
	{ subject: "pol", pct: 94 },
	{ subject: "ang", pct: 91 },
	{ subject: "bio", pct: 88 },
	{ subject: "hist", pct: 86 },
